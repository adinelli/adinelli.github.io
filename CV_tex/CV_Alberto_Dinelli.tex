...
\NewEntry{email}{\href{mailto:alberto.dinelli@unige.ch}{\deepchestnut{alberto.dinelli@unige.ch}}} % Email address

\NewEntry{address}{Département de biochimie $\cdotp$ Université de Genève\\
  \-\hspace{4.0cm}Quai Ernest-Ansermet 30\\
  \-\hspace{4.0cm}CH-1211 Genève (\textit{Suisse})}
...
\begin{tabular}{p{4cm}|p{14cm}} % <=============================
  ...
  \end{tabular}
  & {\textcolor{carmine}{{Postdoc}}}
  \newline
  {Département de biochimie} $\cdotp$ {Université de Genève} $\cdotp$ \textit{Geneva}\\[0.2cm]
  ...
  \end{tabular}
  & {\textcolor{carmine}{{Ph.D. - Physique en Île de France}}}
  \newline
  {Laboratoire Matière et Systèmes Complexes, Université Paris Cité}  $\cdotp$ \textit{Paris}\\[0.2cm]
	\begin{tabular}{p{4.5cm} p{13.5cm}}
  ...
  \end{tabular}
  & \small{$\>\>\cdotp\>\>$} \footnotesize{Visiting period at MIT, group of Prof. J. Tailleur $\cdotp$ \textit{Cambridge}, US}\\[0.05cm]
  \begin{tabular}[t]{@{}l@{}}\parbox{\datebox}{\small 2023-07}
  \end{tabular}
  & \small{$\>\>\cdotp\>\>$} \footnotesize{Visiting period at YITP, group of Prof. H. Hayakawa $\cdotp$ \textit{Kyoto}, JP}\\[0.05cm]
  \begin{tabular}[t]{@{}l@{}}\parbox{\datebox}{\small 2022-10}
  \end{tabular}
  & \small{$\>\>\cdotp\>\>$} \footnotesize{Visiting period at MIT, group of Prof. J. Tailleur $\cdotp$ \textit{Cambridge}, US}\\
  \multicolumn{2}{c}{}\\[0.5cm]
  
  \begin{tabular}[t]{@{}l@{}}\parbox{\datebox}{2019-09 -- 2021-07}
  \end{tabular}
  & {\textcolor{carmine}{{Master in Physics of Complex Systems - International track}}}
  \newline
  {Politecnico di Torino}  $\cdotp$ \textit{Torino} --- {Université Paris-Saclay}  $\cdotp$ \textit{Paris} \\[0.2cm]
  \begin{tabular}{p{4.5cm} p{13.5cm}}
	& \footnotesize\textbf{Final mark:} 110/110 cum laude\\
  ...
  \end{tabular}\\[0.7cm]
  \begin{tabular}[t]{@{}l@{}}\parbox{\datebox}{\small 2019-09 -- 2020-02}
  \end{tabular}
  & \small{$\>\>\cdotp\>\>$} \footnotesize{Visiting period at {SISSA}, {ICTP} $\cdotp$ \textit{Trieste}}\\
  \multicolumn{2}{c}{} \\[0.5cm]
  
  \begin{tabular}[t]{@{}l@{}}\parbox{\datebox}{2016-09 -- 2019-07}
  \end{tabular}
  & {\textcolor{carmine}{{Bachelor degree in Physics}}}\\
  & {Università di Pisa}  $\cdotp$ \textit{Pisa}\\[0.2cm]
  \begin{tabular}{p{4.5cm} p{13.5cm}}
	& \footnotesize\textbf{Final mark:} 110/110 cum laude\\
...
\NewItemEntry{2025}{Best Poster Prize @ \href{https://www.we-heraeus-stiftung.de/veranstaltungen/from-soft-matter-to-biophysics-2025/}{Les Houches Winter School}}\\[\v]
