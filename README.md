...
Information on Jekyll can be found in [this tutorial](https://www.taniarascia.com/make-a-static-website-with-jekyll/), from which we report a few key info.

Jekyll is a static site generator that runs on the Ruby programming language. 
Jekyll relies on [Markdown](https://daringfireball.net/projects/markdown/), a text-to-HTML 
conversion tool which makes writing HTML much easier and more efficient.
A static site generator builds a website using plain HTML files. 

Jekyll requires Bundler to work. Bundler is a package manager that will 
aid you in installing all the Jekyll dependencies.

### Installation

For a hands-on walkthrough of al-folio installation, check out [this video tutorial](https://www.youtube.com/watch?v=g6AJ9qPPoyc) by one of the community members!
